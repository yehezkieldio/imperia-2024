...
import type { ChuckNorrisQueryResult } from "@/internal/types/chucknorris";
...
export class ChunkNorrisCommand extends ImperiaCommand {
    ...
    public async chatInputRun(interaction: ImperiaCommand.ChatInputCommandInteraction) {
        ...
        response.setThumbnail(result.icon_url);
        response.setDescription(result.value);
    ...
    private async getRandomCatFact(): Promise<ChuckNorrisQueryResult | undefined> {
