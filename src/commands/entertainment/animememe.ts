...
export class AnimeMemeCommand extends ImperiaCommand {
    public constructor(context: ImperiaCommand.Context, options: ImperiaCommand.Options) {
        super(context, {
            ...options,
            description: "Get a anime meme from reddit",
            aliases: ["animememes", "animeme", "animemes"],
            tags: ["meme", "image", "anime"],
    ...
    private async getMeme() {
        const { title, url } = await this.container.services.reddit.getRandom("Animemes");
