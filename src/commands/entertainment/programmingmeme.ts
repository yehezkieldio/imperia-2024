...
export class ProgrammingMemeCommand extends ImperiaCommand {
    public constructor(context: ImperiaCommand.Context, options: ImperiaCommand.Options) {
        super(context, {
            ...options,
            description: "Get a programming meme from r/ProgrammerHumor",
            aliases: [
                "programmingmemes",
                "randomprogrammingmeme",
                "randomprogrammingmemes",
                "programminghumour",
                "programminghumor",
                "randomprogramminghumour",
                "randomprogramminghumor",
                "codememe",
                "codememes",
                "developermeme",
                "developermemes",
    ...
    private async getMeme() {
        const { title, url } = await this.container.services.reddit.getRandom("ProgrammerHumor");
