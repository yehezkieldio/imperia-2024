...
export class HistoryMemeCommand extends ImperiaCommand {
    public constructor(context: ImperiaCommand.Context, options: ImperiaCommand.Options) {
        super(context, {
            ...options,
            description: "Get a meme from r/HistoryMemes",
            aliases: ["historymemes"],
            tags: ["meme", "image"],
    ...
    private async getMeme() {
        const { title, url } = await this.container.services.reddit.getRandom("HistoryMemes");
